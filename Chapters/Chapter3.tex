...
\begin{figure}[h]
\centering
\includegraphics[scale=0.7]{Figura 18 - Estructura.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.18]{Figura 29 - Placa ESP32.jpg}
...
\begin{minipage}{0.32\textwidth}
  \centering
  \includegraphics[angle=270, scale=0.35]{Figura 30a - Pantalla principal.jpg}
\end{minipage}%
\begin{minipage}{0.32\textwidth}
  \centering
  \includegraphics[angle=270, scale=0.35]{Figura 30b - Menu principal.jpg}
\end{minipage}
\begin{minipage}{0.32\textwidth}
  \centering
  \includegraphics[angle=270, scale=0.35]{Figura 30c - Datos conexion.jpg}
\end{minipage}
\end{figure}
\begin{figure}[h]
\centering
\begin{minipage}{0.32\textwidth}
  \centering
  \includegraphics[angle=270, scale=0.35]{Figura 30d - Datos red.jpg}
\end{minipage}
\begin{minipage}{0.32\textwidth}
  \centering
  \includegraphics[angle=270, scale=0.35]{Figura 30e - Datos modo.jpg}
\end{minipage}
\begin{minipage}{0.32\textwidth}
  \centering
  \includegraphics[angle=270, scale=0.35]{Figura 30f - Config modo.jpg}
\end{minipage}
