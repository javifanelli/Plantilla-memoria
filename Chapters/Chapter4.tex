...
\begin{figure}[h]
\centering
\includegraphics[scale=0.08]{Figura 37 - Dimmer funcionando.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{Figura 39 - Config.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.33]{Figura 41 - Modificar usuario.png}
