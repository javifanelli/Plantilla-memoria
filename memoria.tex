...
\author{Ing. César Javier Fanelli} % Tu nombre, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \authorname
...
En la presente memoria se describe el diseño de un prototipo de sistema integral de domótica de índole académica. El propósito es aplicar los conocimientos adquiridos en el transcurso del posgrado. En esta primera etapa se implementan dos tipos de nodos y se agregarán a futuro nuevos elementos con otras funcionalidades.
...
Agradezco a docentes, alumnos y no docentes que conforman el posgrado, así como a los directores que me acompañaron en el desarrollo de este trabajo. En especial agradezco a mi esposa e hija, quienes fueron mi apoyo en todo momento y sin quienes no habría podido lograr la hazaña de emprender este viaje arduo y satisfactorio.
