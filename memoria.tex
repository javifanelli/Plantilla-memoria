...
\codirector{Ing. Marı́a Celeste Corominas (FIUBA)} % El nombre del codirector si lo hubiera, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \codirname.  Para activar este campo se debe descomentar la opción "codirector" en el comando \documentclass, línea 23.
...
\dedicatory{\textbf{Dedicado a mi mamá.}}  % escribir acá si se desea una dedicatoria
